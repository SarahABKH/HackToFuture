...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?>Requests not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?>Requests Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Request has been closed</p>
                      </div>
