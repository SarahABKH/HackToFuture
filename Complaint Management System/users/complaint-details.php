...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Picked-Up Id</h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Pick-Up Id : </b></label>
          		<div class="col-sm-4">
...
<div class="row mt">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Pick-Up Type :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Pick-Up Address: </label>
              <div class="col-sm-10">
